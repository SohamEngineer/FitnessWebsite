      ...
      <div className="container exercise__top">
        ...
        <div className="exercise__wrapper">
          <div className="exercise__item" data-aos-duration="1500" data-aos="zoom-in">
            <span className="exercise__icon"><img src={lunges} alt="Lunges" /></span>
          ...
          <div className="exercise__item" data-aos-duration="1500" data-aos="zoom-in">
            <span className="exercise__icon"><img src={yoga} alt="Yoga" /></span>
            <div className="exercise__content">
          ...
          <div className="exercise__item" data-aos-duration="1500" data-aos="zoom-in">
            <span className="exercise__icon"><img src={ex} alt="Blood Pressure" /></span>
            <div className="exercise__content">
